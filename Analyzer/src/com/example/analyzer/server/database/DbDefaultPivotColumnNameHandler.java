...
public class DbDefaultPivotColumnNameHandler implements DbPivotColumnNameHandler
{
  ...
  {
    return pivotColumnName + "/" + seriesValue + "/" + summarizerName + "/" + summarizerColumnName;
  }
