...
public class Quarters extends AbstractCalendarFunction
{
  public Quarters(Evaluator evaluator)
  {
    super(evaluator);
  }
  ...
  {
    int weeks = DbDateUtilities.getWeekOfEpoch(calendar);
    return new Value(weeks, ValueType.INTEGER);
  }
