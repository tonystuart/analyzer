...
public class Years extends AbstractCalendarFunction
{
  public Years(Evaluator evaluator)
  {
    super(evaluator);
  }
  ...
  {
    int years = DbDateUtilities.getYear(calendar);
    return new Value(years, ValueType.INTEGER);
  }
