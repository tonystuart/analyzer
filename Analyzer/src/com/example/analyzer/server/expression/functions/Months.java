...
public class Months extends AbstractCalendarFunction
{
  public Months(Evaluator evaluator)
  {
    super(evaluator);
  }
  ...
  {
    int months = DbDateUtilities.getMonthOfEpoch(calendar);
    return new Value(months, ValueType.INTEGER);
  }
