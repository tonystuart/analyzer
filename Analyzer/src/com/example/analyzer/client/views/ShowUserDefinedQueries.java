...
public class ShowUserDefinedQueries extends MergeTreePanel<QueryContent>
{
  public ShowUserDefinedQueries(String heading)
  {
    super(heading, Analyzer.getInstance().getQueryMergeTreeStore());
    setIcon(Resources.FOLDER_DATABASE);
  }
}
