...
public class ManagedTabFrame extends TabPanel implements ManagedPanel
{

  private static ManagedTabFrame instance;

  public static ManagedTabFrame getInstance()
  {
    return ManagedTabFrame.instance;
  }

  private Rectangle bounds;
  private ViewManager viewManager;

  public ManagedTabFrame()
  {
    hide();
    setInstance(this);
    setBodyBorder(false);
  ...
  private void setInstance(ManagedTabFrame managedTabFrame)
  {
    ManagedTabFrame.instance = managedTabFrame;
  }
