...
import com.example.analyzer.client.views.SummarizeRows;
...
public class ManagedAccordionPanel extends ContentPanel implements ManagedPanel
{
  private static ManagedAccordionPanel instance;

  public static ManagedAccordionPanel getInstance()
  {
    return ManagedAccordionPanel.instance;
  }
  ...
  protected void onRender(Element parent, int index)
  {
    ...
    addViewPanel(new SummarizeRows("Summarize Rows"));
  ...
  private void setInstance(ManagedAccordionPanel managedAccordionPanel)
  {
    ManagedAccordionPanel.instance = managedAccordionPanel;
  }
